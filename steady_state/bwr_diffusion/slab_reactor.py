...
def run() :
  ...
  #inp.put_int("quad_number_polar_octant",   4)
  ...
  inp.put_str("explicit_eigenoperator",             "Operator.out")
  #------------------------------------------------------------------------------#
  # Material
  #------------------------------------------------------------------------------#
